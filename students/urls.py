...
urlpatterns = patterns('',
    ...
    url(r'^student_detail/(?P<student_id>\d+)/$', views.student_detail, name='student_detail'),
    url(r'^student_create/$', views.student_create ,name = 'student_create'),
    url(r'^student_update/(?P<student_id>\d+)$', views.student_update ,name = 'student_update'),
